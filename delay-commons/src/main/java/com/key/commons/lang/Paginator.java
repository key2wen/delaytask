 ...
 * 
 * @author John
 * @version $Id: Paginator.java, v 0.1 2011-12-9 下午1:47:15 John Exp $
 * 
 * 翻页器。
 * 
 * <p>
...
public class Paginator implements Serializable, Cloneable {
    ...
    /**  */
    private static final long serialVersionUID = -4609641846278510068L;
...
//        }
	...
	public int[] getSliderEL() {
    	return getSlider();
    }
    
    public int getPreviousPageEL() {
    	return getPreviousPage();
    }
    
    public int getNextPageEL() {
    	return getNextPage();
    }
